...
public class SavingsAccountTester {
    ...
    public static void main(String[] args) {
        SavingsAccount ramAccount = new SavingsAccount(1.5);
        ramAccount.credit(100000.0);
        System.out.println("current balance of ram account: " + ramAccount.getBalance());
        SavingsAccount.endOfMonth(ramAccount);
        System.out.println("current balance in  ram account after interest: " + ramAccount.getBalance());



      /*  SavingsAccount zudioAccount = new SavingsAccount(1.5);
